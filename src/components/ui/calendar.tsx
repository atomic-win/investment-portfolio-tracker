	...
	return (
		<DayPicker
			...
			classNames={{
				...
				day: cn(
					'relative w-full rounded-(--cell-radius) h-full p-0.5 text-center [&:last-child[data-selected=true]_button]:rounded-r-(--cell-radius) group/day aspect-square select-none',
